...
public class ViewFood extends javax.swing.JFrame {
     ...
     */
    public ViewFood(Connection connection) {
    ...
    private void initComponents() {
        ...
        try {
            ...
            for (int i = 0; i < foods.size(); i++) {
                tblMode1.addRow(new Object[]{foods.get(i).getId(), foods.get(i).getFoodName(), foods.get(i).getFoodQuantity(), foods.get(i).getFoodPrice()});
            }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        new ViewCustomer(connection).setVisible(true);
        setVisible(false);
